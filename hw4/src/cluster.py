...
class Cluster(object) :
    ...
    def centroid(self) :
        ...
        # construct point
        centroid = Point('centroid', cluster_label, points)
        return centroid
        ### ========== TODO : END ========== ###
    ...
    def medoid(self) :
        ...
        for p in self.points:
            ...
            for q in self.points:
                total_dist += p.distance(q)
            avg_dist = total_dist / num_points
            avg_dists.append(avg_dist)
    
        index_min_avg_dist = np.argmin(avg_dists)
        medoid = Point('medoid', self.points[index_min_avg_dist].label, self.points[index_min_avg_dist].attrs)
        return medoid
        ### ========== TODO : END ========== ###
